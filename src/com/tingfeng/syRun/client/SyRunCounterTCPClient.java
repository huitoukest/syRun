...
import com.tingfeng.syRun.client.handler.SyRunCounterClientHandler;
import com.tingfeng.syRun.common.ConfigEntity;

public class SyRunCounterTCPClient {
	...
	public static void initClientConnect() {
		...
		connector.setHandler(SyRunCounterClientHandler.getSigleInstance());
		// Set connect timeout.
