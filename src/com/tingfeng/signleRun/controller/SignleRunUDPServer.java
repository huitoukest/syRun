...
public class SignleRunUDPServer {
	
	private static Logger logger = LoggerFactory.getLogger(SignleRunUDPServer.class);
    ...
    public static void main(String[] args) throws Exception
    {
            ...
            acceptor.setSessionRecycler(new ExpiringSessionRecycler(150 * 1000));          
            // ** UDP通信配置
            ...
            // ** UDP服务端开始侦听
            acceptor.bind(new InetSocketAddress(ConfigEntity.SERVDER_TCP_PORT));
